...
## 프로젝트 주요기능
    ...
    텍스트로 대화처리 API를 통한 정보 전달 및 이미지 객체 검출 데이터를 바탕으로 랜덤퀴즈를 출제하고
    사용자가 답변하는 답을 언어 분석 기술 API를 활용하여
    분석하고 랜덤퀴즈 정답과 사용자가 답변한 답을 비교하여 정답을 사용자에게 전달하여
    이미지에 대한 정보를 사용자에게 전달.
